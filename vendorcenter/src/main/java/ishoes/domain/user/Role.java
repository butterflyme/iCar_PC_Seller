...
public class Role implements Serializable {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(role_id).append(role_name).append(descprtion).toHashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		Role rhs = (Role) obj;
		return new EqualsBuilder().appendSuper(super.equals(obj)).append(role_name, rhs.role_name).append(descprtion,
				rhs.descprtion).isEquals();
	}
}
